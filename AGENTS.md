...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Current active external QA handoff: Dungeons & Degenerate Gamblers Direct Official Build Retry 1 through canonical tester `019ef96e-99ee-7f62-b4d2-7d2c3cd29217`, evidence target `evidence/external/dungeons-degenerate-gamblers-direct-build-retry-1/`, using URL `https://html-classic.itch.zone/html/15020933/index.html`. Scope remains settings/options/help/pause/restart/give-up/volume/fullscreen controls if visible, legal/illegal action clarity, card-state readability, usability/accessibility, performance/load, and provider/environment classification. Do not start another browser QA run until this tester pass closes or blocks.
