...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Next external QA action: choose the next highest-value external methodology pass or deeper follow-up for existing external games; current completed Track 2 statuses include PolyTrack and OvO as `PASS_WITH_FINDINGS`.
