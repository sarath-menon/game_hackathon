...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Current active external QA handoff: PolyTrack Poki Follow-up 3 through canonical tester `019ef96e-99ee-7f62-b4d2-7d2c3cd29217`, evidence target `evidence/external/polytrack-poki-settings-race-followup-1/`, using URL `https://poki.com/en/g/polytrack`. Scope is settings persistence, audio/fullscreen controls, provider locale clarity, pause clarity, short continuous race regression, reset behavior, route readability, and provider/environment classification. Do not start another browser QA run until this tester pass closes or blocks.
