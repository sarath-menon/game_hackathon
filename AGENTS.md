...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Next external QA action: rerun Dungeons & Degenerate Gamblers through the canonical tester in the single shared Chrome window because the older Dungeons report predates the current shared-window rule and used an isolated browser profile.
