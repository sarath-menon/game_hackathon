...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Current active local QA handoff: Side-Scrolling Platformer Settings Polish 2 Retest 1 through the canonical tester, evidence target `evidence/platformer/settings-polish-2-retest-1/`, after browser maintenance closed stale Kart/dashboard tabs and reported shared-window targeting stable enough to retry.
