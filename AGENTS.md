...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Current active external QA handoff: Dungeons & Degenerate Gamblers Follow-up Pass 2 through canonical tester `019ef96e-99ee-7f62-b4d2-7d2c3cd29217`, evidence target `evidence/external/dungeons-degenerate-gamblers-settings-illegal-pass-1/`, using URL `https://purplemosscollectors.itch.io/dndg`. Scope is settings/options/help/pause/restart/give-up/volume/fullscreen controls if visible, legal/illegal action clarity, card-state readability, usability/accessibility, performance/load, and provider/environment classification. Do not start another browser QA run until this tester pass closes or blocks.
