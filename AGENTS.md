...
- Current phase state:
  ...
  - External browser-game QA:
    ...
    - Current active local builder handoff: Side-Scrolling Platformer Settings Polish 2 through the Platformer builder, focused on deeper player settings for accessibility/readability, controls/feel, difficulty/forgiveness, and display/performance. This build must wait for canonical tester QA after the active Kart retest finishes.
